...
class _MainItemState extends State<MainItem> {
  ...
  Future<void> onDownload() async {
    ...
    Fluttertoast.showToast(msg: 'Скачивается');
    await Dio().download(
      widget.model.file!,
      path,
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, CupertinoPageRoute(builder: (context) => PdfPage(url: widget.model.file!, hasPdf: hasPdf, path: path)));
                    },
                    child: Material(
                      borderRadius: BorderRadius.circular(5),
                      color: const Color(0xff017e72),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.all(15),
                    child:
                        Text(widget.model.rating.toString(), style: const TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.w500)),
                  ),
                )
              ],
            ),
