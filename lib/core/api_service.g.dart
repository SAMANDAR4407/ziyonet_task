...
class _ApiService implements ApiService {
  ...
  @override
  Future<CategoryWithQuantity> getCategoriesWithQuantity() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<CategoryWithQuantity>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/library/categories-with-quantity',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = CategoryWithQuantity.fromJson(_result.data!);
    return value;
  }
